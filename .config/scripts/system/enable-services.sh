...
echo "$USER ALL=(ALL) NOPASSWD: /home/$USER/.config/scripts/rofi-battery.sh, /bin/cp, /usr/bin/tlp" | sudo tee /etc/sudoers.d/rofi-battery > /dev/null
...
/home/$USER/.config/scripts/system/custom-boot.sh, \\
/usr/sbin/efibootmgr
EOF
